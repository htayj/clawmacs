...
;; Override the default soul prompt or point to a different prompt file
(setf clawmacs:*system-prompt* "You are a pragmatic pair programmer.")
(setf clawmacs:*system-prompt-path* #P"/home/tay/.config/clawmacs/pair-system-prompt.txt")
(clawmacs:load-system-prompt-file)
...
(clawmacs:register-agent-definition
 ...
 :model "gpt-5.4"
 :think-level "high"
 :tools-prompt "Use lisp_eval for concrete work. Inspect first, then modify."
 :soul-prompt "You are a concise writing partner focused on structure and tone.")
