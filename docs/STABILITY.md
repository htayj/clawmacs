...
- Guix/Quicklisp preflight exited zero. The mocked launcher regression also
  ...
  lock-owner death, hostile source-registry replacement, the four preserved GUI
  controls, and protection of the production cache and pin. Evidence:
...
surfaces were removed after the validation record above. The resulting final
tree was revalidated independently on 2026-07-14:
